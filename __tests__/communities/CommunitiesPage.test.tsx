...
const mockCommunities = {
  joinedCommunities: [
    { id: '1', name: 'Community 1', description: 'Description 1', imageUrl: 'image1.jpg' },
    { id: '2', name: 'Community 2', description: 'Description 2', imageUrl: 'image2.jpg' },
  ],
  recommendedCommunities: [
    { id: '3', name: 'Community 3', description: 'Description 3', imageUrl: 'image3.jpg' },
    { id: '4', name: 'Community 4', description: 'Description 4', imageUrl: 'image4.jpg' },
  ],
};
