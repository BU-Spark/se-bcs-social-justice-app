...
describe('CommunityPage', () => {
  ...
  it('displays community details after loading', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/Welcome to the Community: Test Community/)).toBeInTheDocument();
    });
    
    // Check if description is rendered
    expect(screen.getByText('This is a test community description')).toBeInTheDocument();
  ...
  it('handles API error gracefully', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.queryByText(/Welcome to the Community/)).not.toBeInTheDocument();
    });
  });
}); 